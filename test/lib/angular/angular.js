 ...
 * 
 * <pre>
 * var untild = angular.module('untild', []);
 * untild.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://untild.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://untild.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * <pre class="prettyprint">
 *    angular.module('untild', []).config(function($sceDelegateProvider) {
 ...
 *        'http://untild.example.com/clickThru**']);
 *      });
 * </pre>
 */
...
<file name="index.html">
  <div ng-controller="untildController as myCtrl">
...
<file name="script.js">
  ...
  mySceApp.controller("untildController", function untildController($http, $templateCache, $sce) {
    var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('untildWithSceDisableduntild', []).config(function($sceProvider) {
